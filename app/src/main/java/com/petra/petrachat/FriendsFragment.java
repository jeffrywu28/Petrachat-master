...
public class FriendsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        queryDate = mFriendDatabase.orderByChild("date");
        ...
        FirebaseRecyclerAdapter<Friends, FriendsViewHolder> friendsRecyclerAdapter = new
...

                {
                    ...
                    public FriendsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.user_single,parent,false);
                                            ...
                                            public boolean onMenuItemClick(MenuItem item) {
                                                switch (item.getItemId()) {
                                                    case R.id.messageto:
                                                        // mDatabase.child(post_key).removeValue();
                                                        //handle menu1 click
                                                        Intent chatintent=new Intent(getContext(),ChatsFragment.class);
    ...
    public static class FriendsViewHolder extends RecyclerView.ViewHolder{
        ...
        {
            TextView datefrom=(TextView) mView.findViewById(R.id.user_single_status);
        ...
        public void setImage(String image, Context ctx){
            CircleImageView circleImageView2=(CircleImageView)mView.findViewById(R.id.user_single);
